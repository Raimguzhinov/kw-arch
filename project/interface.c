...
#define MEMORY_VALUES                                                         \
  ...
  while (0)
/*Если старший бит (>> 14) установлен, то это означает, что значение ячейки
 * памяти отрицательное, и его нужно привести к дополнительному коду, обнулив
 * старший бит и инвертировав все остальные биты. Если старший бит не
 * установлен, то значение положительное и выводится с символом + перед ним.*/
