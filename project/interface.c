        ...
        {                                                                                                                 \
          for (int j = 0; j < 10; ++j)                                                                                    \
            {                                                                                                             \
              ...
              if ((value >> 14) & 1)                                                                                      \
                {                                                                                                         \
                  /*Если старший бит (>> 14) установлен, то это означает, что     \
                   * значение ячейки памяти отрицательное, и его нужно          \
                   * привести к дополнительному коду, обнулив старший бит и \
                   * инвертировав все остальные биты. Если старший бит не     \
                   * установлен, то значение положительное и выводится с      \
                   * символом + перед ним.*/                                                              \
